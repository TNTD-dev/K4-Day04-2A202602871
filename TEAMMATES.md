...
The rows below are derived from merged contribution history.
Each member must replace any `CONFIRM` value with their official course record before submission.
